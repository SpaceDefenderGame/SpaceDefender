...
SpaceDefender.LevelInfo = {
  ...
  preload: function () {
    ...
    , create: function () {
		...
		this.commentText = this.game.add.text(this.game.width / 2, 20+this.titleText.bottom, "You can buy 10 health or increase your bullet frequency for 100 BTC and go to the next level");
        ...
        this.btnStart = SpaceDefender.gameButtons.addButton("start", this.game.width / 2, 280+this.commentText.bottom, this.startGame, this);
	...
	, increaseBulletSpeed: function () {
		...
		console.log(SpaceDefender.bulletFrequency);
		SpaceDefender.score -= 100;
		this.scoreText.text = SpaceDefender.score;
		setTimeout ((function() {this.scoreLabel.x = this.game.world.width - this.game.width / 12 - this.scoreText.width - 20;}).bind(this), 0);
		}
