...
SpaceDefender.MainMenu = {
  ...
  preload: function () {
    ...
    , create: function () {       
		...
		this.background = this.add.tileSprite(this.game.world.centerX, this.game.world.centerY, 1920, 1200, 'background');
		...
		this.commentText = this.game.add.text(this.game.width / 2, this.titleText.bottom + this.game.height / 12, "Kill your enemies and earn bitcoins");
